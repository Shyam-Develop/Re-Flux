      ...
      <Grid container spacing={4}>
        {refurbishedProducts.map((product, idx) => (
          <Grid item xs={12} sm={6} md={4} key={idx}>
            ...
            >
              {/* Title & size */}
              <Typography sx={{ ...typography.h4, fontWeight: 400, color: '#0B121E', mb: 0.5, fontSize: { xs: '16px', md: '24px' } }}>
                {product.title}
              </Typography>
              <Typography sx={{ ...typography.h5, fontWeight: 500, color: '#00000099', mb: 1, fontSize: { xs: '12px', md: '20px' } }}>
                {product.size}
              </Typography>
              <Typography sx={{ ...typography.bodySmall, fontWeight: 400, color: '#00000099', mb: 1, fontSize: { xs: '12px', md: '14px' } }}>
              ...
              <Grid container spacing={2} sx={{ mb: 2 }}>
                <Grid item xs={6}>
                  <Typography sx={{ ...typography.h6, fontWeight:600, color: '#0E1626', fontSize: { xs: '12px', md: '16px' } }}>Lift Capacity</Typography>
                  <Typography sx={{ ...typography.bodySmall, fontFamily:"Fira Sans, sans-serif", fontWeight:400, color: '#677489', fontSize: { xs: '12px', md: '14px' } }}>
                    {product.liftCapacity}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography sx={{ ...typography.h6, fontWeight:600, color: '#0E1626', fontSize: { xs: '12px', md: '16px' } }}>Power Supply</Typography>
                  <Typography sx={{ ...typography.bodySmall, fontFamily:"Fira Sans, sans-serif", fontWeight:400, color: '#677489', fontSize: { xs: '12px', md: '14px' } }}>
                    {product.powerSupply}
                  </Typography>
                </Grid>
              ...
              {/* Included */}
              <Box sx={{ mb: 3 }}>
                <Typography sx={{ ...typography.h6,  fontWeight:600, color: '#0E1626', fontSize: { xs: '12px', md: '16px' } }}>Included</Typography>
                <Typography sx={{ ...typography.bodySmall, fontFamily:"Fira Sans, sans-serif", fontWeight:400, color: '#677489', fontSize: { xs: '12px', md: '14px' } }}>
                  {product.included}
                </Typography>
              </Box>
