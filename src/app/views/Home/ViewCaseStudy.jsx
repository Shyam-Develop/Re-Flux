...
const ViewCaseStudy = () => {
  ...
  const mainImage = content
    ? `https://refluxmagnets.com${content.CON230030}`
    : null;
  ...
  for (let i = 0; i < 50; i++) {
    ...
    thumbnailImages.push({
      ...
      src: `https://refluxmagnets.com${content[key]}`,
    });
  }
  ...
  const items = [
    {
      img: `https://refluxmagnets.com${content.CON210021}`,
    ...
    {
      img: `https://refluxmagnets.com${content.CON210024}`,
      title: content.CON210025,
      imgId: "CON210024",
      titleId: "CON210025",
    },
    {
      img: `https://refluxmagnets.com${content.CON210026}`,
      title: content.CON210027,
      imgId: "CON210026",
      titleId: "CON210027",
    },
    {
      img: `https://refluxmagnets.com${content.CON210028}`,
    ...
    <>
      ...
      >
        ...
        >
          <Box
            component="img"
            src={`https://refluxmagnets.com${content.CON210002}`}
            alt={content.CON210002_ALT}
            sx={{
              ...
              >
                ...
                >
                  <Box
                    component="img"
                    src={item.img}
                    alt={content?.[`${item.imgId}_ALT`] || item.title}
                    sx={{
          ...
          >
            ...
            >
              <Box sx={{ position: "relative" }}>
                <Box
                  component="img"
                  src={`https://refluxmagnets.com${content.CON210038}`} // Static image, no change on hover
                  alt={content.CON210038_ALT}
                  sx={{
                    width: "100%",
        ...
        >
          <Box
            component="img"
            src={selectedImage}
            alt={content?.[`CON230030_ALT`] || "Circular Lifting Magnet"}
            sx={{
              width: "100%",
          ...
          {thumbnailImages.map((img, index) => (
            <Box key={img.id} sx={{ position: "relative" }}>
              <Box
                component="img"
                src={img.src}
               alt={content?.[`${img.id}_ALT`] || `Thumbnail ${index + 1}`}
            ...
            >
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.CON2400008}`}
                    alt={content.CON2400008_ALT}
                    sx={{
                      width: "100%",
