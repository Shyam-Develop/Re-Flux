  ...
  const refurbishedProducts = [
    {
      ...
      imgSrc: `https://refluxmagnets.com${content.RM1011_IMG}`,
      keys: [
        "RM1011",
        "RM1012",
        "RM1013",
    ...
    },
    {
      ...
      imgSrc: `https://refluxmagnets.com${content.RM1017_IMG}`,
      keys: [
        "RM1017",
        "RM1018",
        "RM1019",
    ...
    },
    {
      ...
      imgSrc: `https://refluxmagnets.com${content.RM1023_IMG}`,
      keys: [
        "RM1023",
        "RM1024",
        "RM1025",
    ...
    },
    {
      ...
      imgSrc: `https://refluxmagnets.com${content.RM1029_IMG}`,
      keys: [
        "RM1029",
        "RM1030",
        "RM1031",
    ...
    },
    {
      ...
      imgSrc: `https://refluxmagnets.com${content.RM1035_IMG}`,
      keys: [
        "RM1035",
        "RM1036",
        "RM1037",
    ...
    },
    {
      ...
      imgSrc: `https://refluxmagnets.com${content.RM1041_IMG}`,
      keys: [
        "RM1041",
        "RM1042",
        "RM1043",
    ...
    >
      ...
      >
        ...
        <Box
          component="img"
          src={product.imgSrc}
          alt={content?.[`${product.keys[6]}_ALT`] || product.title}
          sx={{
            width: "100%",
            height: "240px",
            objectFit: "cover",
  ...
  const blogData = [
    {
      ...
      date: content.RM1102,
      image: `https://refluxmagnets.com${content.RM1103}`,
    },
    {
      title: content.RM1104,
      author: content.RM1105,
      date: content.RM1106,
      image: `https://refluxmagnets.com${content.RM1107}`,
    },
    {
      title: content.RM1108,
      author: content.RM1109,
      date: content.RM1110,
      image: `https://refluxmagnets.com${content.RM1111}`,
    },
    {
      title: content.RM1112,
      author: content.RM1113,
      date: content.RM1114,
      image: `https://refluxmagnets.com${content.RM1115}`,
    },
  ];
              ...
              {servicesnew.map((service) => (
                ...
                >
                  ...
                  >
                    <Box
                      component="img"
                      src={`https://refluxmagnets.com${content?.[service.imgId] || ""
                        }`}
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            ...
            >
              <CardMedia
                component="img"
                image={`https://refluxmagnets.com${content.RM1078}`}
                alt={content.RM1079}
                sx={{
                  height: "100%",
                  width: "100%",
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <CardMedia
                component="img"
                image={`https://refluxmagnets.com${content.RM1081}`}
                alt={content.RM1082}
                sx={{
                  height: "100%",
                  width: "100%",
              ...
              >
                <Box sx={{ position: "relative" }}>
                  <CardMedia
                    ...
                    alt={content?.[`RM1103_ALT`] || blogData[0].title}
                    sx={{
                      borderRadius: 3,
                      width: "100%",
                      ...
                      >
                        <Box sx={{ position: "relative" }}>
                          <CardMedia
                            component="img"
                            image={item.image}
                            alt={content?.[`RM${base + 3}_ALT`] || item.title}
                            sx={{
