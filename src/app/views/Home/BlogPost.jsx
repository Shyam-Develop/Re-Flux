...
const BlogPost = () => {
    ...
    return (
        <>
            <Box sx={{ bgcolor: '#fff', mx: 'auto', width: '100%', maxWidth: '1200px', }}>
                <Box sx={{ mx: 'auto', px: { xs: 2, md: 0 } }}>
                    <Typography
                        sx={{
                            ...typography.displayL,
                            fontWeight: 700,
                    ...
                    <Box>
                        ...
                        >
                            <Box
                                component="img"
                                src={`https://refluxmagnets.com${content.BP1002}`}
                                alt={content.BP1002_ALT || "Main blog post"}
                                sx={{
                                    width: '100%',
                            ...
                            <Grid item xs={12} key={idx}>
                                ...
                                >
                                    ...
                                    <Box sx={{ position: "relative", width: { xs: "100%", md: 296 }, flexShrink: 0 }}>
                                        <Box
                                            component="img"
                                            src={`https://refluxmagnets.com${item.img.value}`}
                                            alt={
                                                content?.[`${item.img.id}_ALT`] ||
                                                `${item.title.value} blog post cover image`
                                            }
                                            sx={{
                                                width: "100%",
                                    ...
                                    <Grid item xs={12} md={6} key={index}>
                                        <Box>
                                            ...
                                            <Box sx={{ position: "relative", mb: 2 }}>
                                                <Box
                                                    component="img"
                                                    src={`https://refluxmagnets.com${post.img.value}`}
                                                    alt={
                                                        content?.[`${post.img.id}_ALT`] ||
                                                        `${post.title.value} blog post cover image`
                                                    }
                                                    sx={{
                                                        width: "100%",
