            ...
            <Grid item xs={12} md={8}>
              ...
              <Box>
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1003}`}
                    alt={ content?.BD1003_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1006}`}
                    alt={ content?.BD1006_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1011}`}
                      alt={ content?.BD1011_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1016}`}
                      alt={ content?.BD1016_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1020}`}
                    alt={ content?.BD1020_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1024}`}
                    alt={ content?.BD1024_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1028}`}
                      alt={ content?.BD1028_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1032}`}
                      alt={content?.BD1032_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1037}`}
                    alt={content?.BD1037_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
              ...
              <Box >
                ...
                >
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1040}`}
                    alt={ content?.BD1040_ALT || "Main blog visual"}
                    sx={{
                      width: '100%',
                      height: 'auto',
                      maxHeight: 426,
            ...
            <Grid item xs={12} md={4} sx={{ cursor: 'pointer' }} >
              ...
              <Box mb={4}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1046}`}
                    alt={ content?.BD1046_ALT || "Electro Lifting Magnet Innovations"}
              ...
              <Box mb={4} marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1050}`}
                    alt={ content?.BD1050_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box mb={4} marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1054}`}
                    alt={ content?.BD1054_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1058}`}
                    alt={ content?.BD1058_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1062}`}
                    alt={ content?.BD1062_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1066}`}
                    alt={ content?.BD1066_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1070}`}
                    alt={ content?.BD1070_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1074}`}
                    alt={ content?.BD1074_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1078}`}
                    alt={ content?.BD1078_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1082}`}
                    alt={ content?.BD1082_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1086}`}
                    alt={ content?.BD1086_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
              ...
              <Box marginTop={'20%'}>
                <Box sx={{ position: 'relative', width: '100%' }}>
                  <Box
                    component="img"
                    src={`https://refluxmagnets.com${content.BD1090}`}
                    alt={ content?.BD1090_ALT || "Electro Lifting Magnet Innovations"}
                    sx={{ width: '100%', height: 151, objectFit: 'cover', mb: 1.5 }}
                  />
                  <Box
                    sx={{
