  ...
  const blogData = [
    {
      ...
      date: content.SM1062,
      image: `https://refluxmagnets.com${content.SM1063}`,
    },
    {
      title: content.SM1064,
      author: content.SM1065,
      date: content.SM1066,
      image: `https://refluxmagnets.com${content.SM1067}`,
    },
    {
      title: content.SM1068,
      author: content.SM1069,
      date: content.SM1070,
      image: `https://refluxmagnets.com${content.SM1071}`,
    },
    {
      title: content.SM1072,
      author: content.SM1073,
      date: content.SM1074,
      image: `https://refluxmagnets.com${content.SM1075}`,
    },
  ];
              ...
              >
                <Box sx={{ position: "relative" }}>
                  <CardMedia
                    ...
                    alt={
                      content?.[`SM1063_ALT`] ||
                      `${blogData[0].title} blog post image`
                    }
                    sx={{
                      borderRadius: 3,
                      width: "100%",
                      ...
                      >
                        <Box sx={{ position: "relative" }}>
                          <CardMedia
                            ...
                            image={item.image}
                            alt={
                              content?.[`SM${base + 3}_ALT`] ||
                              `${item.title} blog post image`
                            }
                            sx={{
